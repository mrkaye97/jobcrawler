...
from jobcrawler.scraping.dead_links import test_for_dead_links, send_dead_links_notification_email
...
sched.add_job(id="dead_link_email", func=send_dead_links_notification_email, trigger="interval", seconds=5)